...
const CustomKeypad = ({ amount, onKeyPress, onEnter, onClose }) => {
    ...
    const disableClearButton = amount === '0' || amount.length === 0;
        ...
        <div className={styles.keypadContainer} ref={keypadRef} data-testid="keypad">
            ...
            <div className={styles.keypadRow}>
                <button 
                  ...
                  className={disableDotButton ? styles.disabledButton : ''}
                >.</button>
                <button onClick={() => onKeyPress('0')}>0</button>
                <button 
                  onClick={() => onKeyPress('C')} 
                  disabled={disableClearButton} 
                  className={disableClearButton ? styles.disabledButton : ''}
                >x</button>
            </div>
            <div className={styles.keypadRow}>
