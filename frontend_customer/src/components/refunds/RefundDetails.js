        ...
        <div className={styles.screen} data-testid="refund-details-view"> 
            ...
            <div className={styles.content}>
                ...
                {(status === "APPROVED") ? <div className={styles.fullWidthSection}>
                    ...
                    <div className={styles.row}>
                        <span data-testid="refund-transaction-id"><b>REPAYLAH798329781223872</b></span>
                    </div>
                </div> :<></>}
                ...
                <div className={styles.fullWidthSection}>
                    <div className={styles.row}>
                        ...
                        <span data-testid="refund-amount-to-be-refunded"><b>SGD {parseFloat(parseFloat(refund.expect_amount)+parseFloat(refund.refund_amount)).toFixed(2)}</b></span>
                    </div>
                    <div className={styles.row}>
