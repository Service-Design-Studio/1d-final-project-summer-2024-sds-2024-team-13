...
class TransactionsTest < ApplicationSystemTestCase
  ...
  test "should create transaction" do
    ...
    fill_in "Paymentmethod", with: @transaction.paymentMethod
    fill_in "Timestamp", with: @transaction.timestamp
    fill_in "Transactionid", with: @transaction.transactionID
    fill_in "Transactionsum", with: @transaction.transactionSum
    fill_in "Userid", with: @transaction.userID
